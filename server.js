    ...
    mysqlConnection.query(
      ...
      function (err, rows, fields) {
        ...
        if (1 == here1) {
                                                  ...
                                                  function (terr, trow, tfields) {
                                                    ...
                                                    mysqlConnection.query("select balance from wallet where aadhar_no=?", [found[1]], function (tyerr, tyrows, tyfields) {
                                                      ...
                                                      if (tyjson[0].balance >= tjson[0].price) {
                                                        ...
                                                        res.write(
                                                          "<!DOCTYPE html> <head></head>  <body> <br>  <h1> Low Balance . . .  To Recharge , <a href='http://34.70.139.124:3000/'> Click Here. . .</a></h1></body>"
                                                        );
          ...
          res.write(
            "<!DOCTYPE html> <head></head>  <body> <br>  <h1>Wallet is empty . . . To Recharge , <a href='http://34.70.139.124:3000/'> Click Here. . .</a></h1></body>"
          );
